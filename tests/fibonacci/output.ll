...
whilebody:                                        ; preds = %whilecondition
  ...
  %int_sle = icmp sle i32 %c5, 1
  %ifcond = icmp ne i1 %int_sle, false
...
then:                                             ; preds = %whilebody
  ...
  store i32 %int_add, ptr %next, align 4
